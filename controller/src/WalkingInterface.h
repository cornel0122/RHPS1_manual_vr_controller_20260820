...
struct WalkingInterface
{
  ...
  /** Get the reference velocity for walking */
  virtual Eigen::Vector3d get_planner_ref_vel() = 0;
  ...
  /** Get the duration of the next double support phase */
  virtual double next_ts() = 0;
};
